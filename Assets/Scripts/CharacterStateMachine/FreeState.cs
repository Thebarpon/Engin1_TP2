...
public class FreeState : CharacterState
{
    ...
    private void ApplyMovementsOnFloorFU(Vector2 inputVector2)
    {
        ...
        var vectorOnFloor = Vector3.ProjectOnPlane(m_stateMachine.Cine_Camera.transform.forward * inputVector2.y, Vector3.up);
        vectorOnFloor += Vector3.ProjectOnPlane(m_stateMachine.Cine_Camera.transform.right * inputVector2.x, Vector3.up);
    ...
    {
        var forwardCamOnFloor = Vector3.ProjectOnPlane(m_stateMachine.Cine_Camera.transform.forward, Vector3.up);
